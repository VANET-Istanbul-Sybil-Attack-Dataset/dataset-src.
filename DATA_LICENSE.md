...
* **Infrastructure:** The simulation was executed exclusively on **private dedicated servers (Hetzner) and personal hardware** owned and paid for by Taner Guven. No university or institutional computing resources were utilized for the generation of this data.
...
* **Technical Labor:** The custom simulation software built on Veins/OMNeT++ is single-threaded and highly unstable. The generation process required constant manual intervention, monitoring, and error recovery, all performed solely by the owner.
