...
**Legal Note:** As the sole funder of the **computational infrastructure** and executor of this work, the owner retains full **Sui Generis Database Rights** under applicable copyright laws. Furthermore, due to the extensive manual filtering, cleaning, and structural merging required to create the final functional dataset, the owner retains **full standard Copyright over the selection, arrangement, and original compilation** of this data under applicable intellectual property laws. The dataset is NOT "work for hire" and is NOT public domain.
